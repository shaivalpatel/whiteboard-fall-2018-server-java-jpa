...
public class ImageWidgetService {
	...
	@GetMapping("/api/widget/image/{wid}")
	...
	@DeleteMapping("/api/topic/{tid}/image/list/{wid}")
	...
	@PostMapping("/api/topic/{tid}/widget/image/{wid}")
	...
	@PutMapping("api/topic/{tid}/widget/image/{wid}")
